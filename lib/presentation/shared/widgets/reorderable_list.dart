...
// - Added external ScrollController
// - Lowered dropAreaExtent to 8.0 from 100.0
//   (gets rid of empty space at the bottom)
//-----------------
...
class _ReorderableListContentState extends State<_ReorderableListContent> with TickerProviderStateMixin<_ReorderableListContent> {
  ...
  //
  // TODO: find a way to make it 0.0 while maintaining UX
